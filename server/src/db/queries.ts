 ...
 *
 * NOTE: Superseded by `getLastNotificationForSellerChannel` once the
 * per-channel cooldown refactor lands. Kept for one cycle to avoid a
 * cross-cutting churn commit; remove when no callers remain.
 */
